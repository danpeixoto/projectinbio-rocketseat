...
export default function Pricing() {
  return <div className="my-[150px] flex flex-col items-center gap-14">
    ...
    <div className="flex items-end gap-9">
      <div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xl border border-[#1e1e1e]">
        <div className="flex flex-col">
          ...
          <span className="text-white font-bold text-2xl">Apenas</span>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-white font-bold text-[48px]">R$ 9,99</span>
